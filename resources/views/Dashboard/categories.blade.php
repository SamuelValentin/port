        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="flex-auto block py-8 pt-6 px-9">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full my-0 align-middle text-dark border-neutral-200 dark:text-white">
                            ...
                            @foreach ($categories as $item)
                                <tr class="border-b border-dashed last:border-b-0">
                                    ...
                                    <td class="p-3 pr-12 text-start">
                                        <span class="align-baseline inline-flex px-4 py-3 mr-auto font-semibold text-[.95rem] leading-none text-primary bg-primary-light rounded-lg"> {{$item->description}} </span>
                                    </td>
                                    <td class="p-3 pr-0 text-end">
                                        <a href="{{ route('categories.editar', $item->id) }}">
