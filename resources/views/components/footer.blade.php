<!-- component -->
<footer class="bg-gradient-to-r mb-0 from-gray-100 via-[#bce1ff] to-gray-100 dark:text-white dark:from-sky-950 dark:via-indigo-950 dark:to-sky-950">
    <div class="max-w-2xl mx-auto text-gray-600 dark:text-gray-300 py-3">
        <div class="mt-5 flex flex-col md:flex-row md:justify-between items-center text-sm">
            <div>
                ...
                <p class="order-2 md:order-1 mt-2 md:mt-2"> &copy; Samuel Valentin, 2024. </p>
            </div>
