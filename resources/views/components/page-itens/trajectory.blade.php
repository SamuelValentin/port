<section class="body-font border-t text-gray-700 dark:text-gray-200 border-gray-500">
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
        <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:pl-12 text-center">
            <div class="flex flex-col mb-10 items-center">
                ...
                <div class="flex-grow">
                    <h2 class="text-lg title-font font-medium mb-1 text-gray-800 dark:text-gray-300">{{__('home.Experiences-title-1')}}</h2>
            ...
            <div class="flex flex-col mb-10 items-center">
                ...
                <div class="flex-grow">
                    <h2 class="text-lg title-font font-medium mb-1 text-gray-800 dark:text-gray-300">Mobou</h2>
            ...
            <div class="flex flex-col mb-10 items-center">
                ...
                <div class="flex-grow">
                    <h2 class="text-lg title-font font-medium mb-1 text-gray-800 dark:text-gray-300">Hipe Innovation Center</h2>
